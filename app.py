...
#     reason.append("Low inventory ➜ price increased slightly")
# elif inventory_signal < 0:
#     reason.append("High inventory ➜ price reduced slightly")
# 
# if ads_signal > 0:
#     reason.append("High ACOS ➜ price increased to protect margin")
# elif ads_signal < 0:
#     reason.append("Efficient ads ➜ price optimized for volume")
# 
# if risk_signal > 0:
#     reason.append("High returns ➜ price adjusted for risk")
# 
# if not pd.isna(competitor_avg):
...
#     st.write("•", r)
# 
# st.success(f"📌 Final Price ensures **≥ Minimum Margin** and aims for **Target Margin** while balancing demand, ads & risk.")
# 
# 
# # ======================
# # SALES TREND
